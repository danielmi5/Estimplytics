	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.POST, "/api/requests/**", "/api/projects/**", "/api/impact-analysis/**", "/api/estimations/**").hasAnyAuthority("ADMIN", "ANALYST")
				.requestMatchers(HttpMethod.PUT, "/api/requests/**", "/api/projects/**", "/api/impact-analysis/**", "/api/estimations/**").hasAnyAuthority("ADMIN", "ANALYST")
				.requestMatchers(HttpMethod.DELETE, "/api/requests/**", "/api/projects/**").hasAnyAuthority("ADMIN", "ANALYST")
